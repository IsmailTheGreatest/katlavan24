                                                ...
                                                return Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(AppLocalizations.of(context)!.enterCode, style: AppStyles.s18w600),
                                                      SizedBox(height: 8),
                                                      ...
                                                      Form(
                                                        child: PinCodeTextField(
                                                          ...
                                                          onChanged: (String changed){
                                                            if(changed.length==6){
                                                              context.read<LoginCubit>().login(pinTheme: PinTheme(
                                                                ...
                                                                navigateReplaceAll(context,ClientHomePage() );
                                                              }
