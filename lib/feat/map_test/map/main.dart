...
import 'package:katlavan24/feat/map_test/common/theme.dart';
...
import 'package:katlavan24/feat/map_test/map/permissions/permission_manager.dart' show PermissionManager, PermissionType;
import 'package:katlavan24/feat/map_test/map/widgets/map_control_button.dart' show MapControlButton;
...
void main() async {
   ...
   */
  init.initMapkit(apiKey: "99aac6a8-30e3-4247-9fd8-d4681e76db6a");
  runApp(
    MaterialApp(
...
class _MapkitFlutterAppState extends State<MapkitFlutterApp>
  ...
  late final arrowIconImageProvider =
      image_provider.ImageProvider.fromImageProvider(
          const AssetImage("assets/current.png"));
